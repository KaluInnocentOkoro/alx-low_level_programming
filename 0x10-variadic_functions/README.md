...
At the end of this project, you are expected to be able to [explain to anyone](https://alx-intranet.hbtn.io/rltoken/ibS4gLVrbsqSDUdPhq_4Vg "explain to anyone"), **without the help of Google**:
